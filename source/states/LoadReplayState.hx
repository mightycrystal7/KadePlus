...
class LoadReplayState extends states.MusicBeatState
{
	...
	public function addSong(songName:String, weekNum:Int, songCharacter:String)
        {
            songs.push(new states.FreeplayState.SongMetadata(songName, weekNum, songCharacter));
        }
	...
	override function update(elapsed:Float)
	{
		super.update(elapsed);
			...
			if (controls.ACCEPT && grpControls.members[curSelected].text != "No Replays...")
			{
				...
				PlayState.SONG = backend.Song.loadFromJson(poop, PlayState.rep.replay.songName.toLowerCase());
