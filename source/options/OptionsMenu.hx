...
class OptionsMenu extends states.MusicBeatState
{
	...
	var options:Array<OptionCatagory> = [
		new OptionCatagory("Gameplay", [
			...
			new Modcharts("Enables or shuts off modcharts. (eg. takeover moving the arrows in circles)."),
		...
		new OptionCatagory("Appearence", [
			...
			new NoFps("Choose between complex fps or just a watermark"),
			new NPSDisplayOption("Shows your current Notes Per Second.")
		]),
		new OptionCatagory("Misc", [
			#if desktop
			new FPSOption("Toggle the FPS Counter"), new ReplayOption("View replays"),
			#end
